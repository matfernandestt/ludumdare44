...
{
    [MenuItem("Tools/Delete PlayerPrefs data #_r", false, 1)] // Shift + R
    private static void ClearPlayerPrefs()
    {
        PlayerPrefs.DeleteAll();
    }

    [MenuItem("Tools/Edit Collider %_e", false, 10)] // Ctrl + E
...
[MenuItem("Tools/Reset Transform/Reset Transform &_q", false, 10)] // Alt + Q
    ...
    [MenuItem("Tools/Reset Transform/Reset Transform Position &_w", false, 10)] // Alt + W
    ...
    [MenuItem("Tools/Reset Transform/Reset Transform Rotation &_e", false, 10)] // Alt + E
    ...
    public static void AlignToSelected()
    {
        ...
        currentSceneView.AlignViewToObject(Selection.activeGameObject.transform);
    }
